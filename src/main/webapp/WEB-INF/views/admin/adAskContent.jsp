  		...
  		if(ans) {
  			if(answer == 'NO') {
  				...
  				$.ajax({
  					...
  					success:function(data) {
  						alert("문의를 삭제하였습니다.");
  						location.href="${ctp}/ask/adAskList?part=${vo.part}";
  					},
  					error : function() {
  						alert("오류");
  					}
	...
	<c:if test="${vo.part == '신고' }">
		...
		<div id="frame">
			<div id="main">
				...
				<div id="askBtn">
					<input type="button" value="삭제" class="btn btn-secondary" onclick="del('${vo.idx}','${vo.answer}')">
					<input type="button" value="돌아가기" class="btn btn-secondary" onclick="location.href='${ctp}/ask/adAskList?part=${vo.part }'">
				</div>
			</div>
		</div>
<!-- --------------- 댓글------------ -->
...
<div id="repl" >
	...
	<form method="post" name="myForm">
			<div style="margin-top:100px;"> 
				...
				<div style="text-align: right;" id="rep"><input type="button" value="답변하기" class="btn btn-secondary" style="width:180px;" onclick="check(${vo.idx})"/></div>
			</div>
	</form>
</div>
<!-- ------------------댓글-------------------- -->
