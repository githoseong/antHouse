...
<jsp:include page="/WEB-INF/views/include/header.jsp"/>
	...
	<div id="title2">My Page</div>
		...
		<div id="twoFrame">
			...
			<div class="twoFrame"><i class="fa-regular fa-envelope imo"></i><div class="infor">문의 내역</div>관리자에게 보낸<br/> 1:1문의 내역을 확인합니다.</div>
			...
			<div class="twoFrame"><i class="fa-regular fa-calendar-days imo"></i><div class="infor">나의 일정</div>개미굴 캘린더에<br/> 자신이 올린 일정을 확인합니다.</div>
